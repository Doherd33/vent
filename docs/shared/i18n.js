...
(function() {
  ...
  const T = {
    ...
    en: {
      ...
      'demo.d2.title':      'SOP Search',
      'demo.d2.desc':       'The batch record says 100 litres of WFI. Something feels wrong. Search in plain language.',
      'demo.d2.voice':      'Same situation. The Process Batch Record says flush the ATF filter with 100 litres of WFI. Something feels wrong. You open Vent and search in plain language.',

      'demo.d3.title':      'SOP Library',
      'demo.d3.desc':       'Every SOP for your facility — searchable by keyword or AI.',
      'demo.d3.voice':      'Every SOP for your facility lives here — searchable by keyword or by AI.',
      'demo.d3.sub1.title': 'AI Discovery',
      'demo.d3.sub1.desc':  'Describe what you\'re working on. The AI finds the right documents.',
      'demo.d3.sub1.voice': 'Describe what you\'re doing. The AI finds the relevant documents.',
      'demo.d3.sub2.title': 'Keyword Search',
      'demo.d3.sub2.desc':  'Search by keyword — results appear as you type.',
      'demo.d3.sub2.voice': 'Or search by keyword. Results appear as you type.',
      'demo.d3.sub3.title': 'Mismatch Found',
      'demo.d3.sub3.desc':  'The SOP says 150 litres. The mismatch is flagged automatically.',
      'demo.d3.sub3.voice': 'In seconds, the SOP shows 150 litres. The mismatch is flagged automatically. That ATF filter costs fifty thousand euro. If the flush is wrong, you risk damaging it — or contaminating the batch.',

      'demo.d4.title':      'Raise a Concern',
      'demo.d4.desc':       'The operator flags what they found. Plain language. 30 seconds. Done.',
      'demo.d4.voice':      'Now the operator clicks Raise a Concern. Describes what they found in plain language. 30 seconds. Done. Back to work.',
      'demo.d4.sub1.title': 'What You Found',
      'demo.d4.sub1.desc':  'PBR says 100L, SOP says 150L — describe the mismatch.',
      'demo.d4.sub1.voice': 'PBR says 100 litres, SOP says 150. Write it down or speak it.',
      'demo.d4.sub2.title': 'Priority',
      'demo.d4.sub2.desc':  'Flag the urgency. This one\'s high — fifty thousand euro filter at risk.',
      'demo.d4.sub2.voice': 'Flag the priority. This one\'s high — fifty thousand euro filter at risk.',
      'demo.d4.sub3.title': 'Evidence',
      'demo.d4.sub3.desc':  'Attach a photo of the batch record step.',
      'demo.d4.sub3.voice': 'Attach a photo of the PBR step. Visual evidence.',
      'demo.d4.sub4.title': 'Submit',
      'demo.d4.sub4.desc':  'Goes straight to QA Document Control. Anonymous.',
      'demo.d4.sub4.voice': 'Hit submit. Goes straight to QA Document Control. Anonymous.',

      'demo.d5.title':      'Next: QA Document Control',
      'demo.d5.desc':       'Let\'s see the other side — where that concern lands.',
      'demo.d5.voice':      'Now let\'s see the other side. Where does that concern go?',
