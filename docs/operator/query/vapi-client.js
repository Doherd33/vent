// ═══════════════════════════════════════════════════════════════════════════════
// VAPI Client — Real-time Voice Pipeline for Charlie
// ═══════════════════════════════════════════════════════════════════════════════
...
(function(){
  ...
  // ── Hook into existing Charlie toggle ───────────────────────────────────────
  // Override the global toggle if VAPI is enabled
  var _originalToggle = window.toggleCharlie;
  var _originalClose = window.closeCharlie;

  window.toggleCharlie = function(){
    if(!vapiEnabled){
