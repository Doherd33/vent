...
(function() {
  ...
  const T = {
    ...
    en: {
      ...
      // Feedback Loop
      'nav.feedback':           'Feedback',
      'fb.title':               'Voice Feedback',
      'fb.sessions':            'Feedback Sessions',
      'fb.noSessions':          'No feedback sessions yet. Tap the orb to start one.',
      'fb.startSession':        'Start Feedback Session',
      'fb.endSession':          'End Session',
      'fb.tapToStart':          'Tap the orb to start a feedback session',
      'fb.recording':           'Listening\u2026 share your thoughts',
      'fb.thinking':            'Processing\u2026',
      'fb.speaking':            'Charlie is responding\u2026',
      'fb.sessionEnded':        'Session complete \u2014 analysing feedback',
      'fb.analysing':           'Analysing feedback\u2026',
      'fb.analysed':            'Analysis complete',
      'fb.generatePrompt':      'Generate Prompt',
      'fb.generatingPrompt':    'Generating implementation prompt\u2026',
      'fb.promptReady':         'Prompt ready \u2014 copy to clipboard',
      'fb.copied':              'Copied!',
      'fb.copyPrompt':          'Copy to Clipboard',
      'fb.trendReport':         'Trend Report',
      'fb.generateTrend':       'Generate Trend Report',
      'fb.export':              'Export',
      ...
      'fb.keyQuotes':           'Key Quotes',
      'fb.actionItems':         'Action Items',
      'fb.summary':             'Summary',
      'fb.filterAll':           'All',
      'fb.filterActive':        'Active',
      'fb.filterCompleted':     'Completed',
      'fb.filterAnalysed':      'Analysed',
      'fb.batchAnalyse':        'Batch Analyse',
      'fb.voiceCapture':        'Voice Capture',
      'fb.noSelection':         'Select a session to view details',
      'fb.reanalyse':           'Re-analyse',
      'fb.promptPanel':         'Generated Prompt',
      'fb.active':              'Active',
      ...
      // ── DEMO TOUR — Part 1 (Query page) ──────────────────────────────────
      // Narration integrated from NDRC pitch script (slides 4-5)
      // Target: ~280 words total across Parts 1+2 → ~2 min narration
      'demo.d1.title':      'Welcome to Vent',
      'demo.d1.desc':       'See what happens when an operator spots a documentation mismatch on the pharma floor.',
      'demo.d1.voice':      'Welcome to Vent. Let me show you what happens when an operator spots a documentation mismatch on the pharma floor.',

      'demo.d2.title':      'Ask Charlie',
      'demo.d2.desc':       'The batch record says 100 litres of WFI. Something feels wrong. Let\'s ask Charlie.',
      'demo.d2.voice':      'The Process Batch Record says flush the ATF filter with 100 litres of WFI. Something feels wrong. Let\'s ask Charlie — in plain language.',

      'demo.d3.title':      'Charlie\'s Answer',
      'demo.d3.desc':       'Charlie searched your SOPs and found the answer. The SOP says 150L — there\'s a mismatch.',
      'demo.d3.voice':      'In seconds, Charlie found the answer from SOP-BIO-047. The SOP says 150 litres. The batch record says 100. That\'s a 50 litre mismatch on a fifty thousand euro filter.',

      'demo.d4.title':      'SOP Library',
      'demo.d4.desc':       'Every SOP for your facility — searchable by keyword or AI.',
      'demo.d4.voice':      'Every SOP for your facility lives here — searchable by keyword or by AI.',
      'demo.d4.sub1.title': 'AI Discovery',
      'demo.d4.sub1.desc':  'Describe what you\'re working on. The AI finds the right documents.',
      'demo.d4.sub1.voice': 'Describe what you\'re doing. The AI finds the relevant documents.',
      'demo.d4.sub2.title': 'Keyword Search',
      'demo.d4.sub2.desc':  'Search by keyword — results appear as you type.',
      'demo.d4.sub2.voice': 'Or search by keyword. Results appear as you type.',
      'demo.d4.sub3.title': 'Results',
      'demo.d4.sub3.desc':  'Your entire SOP library, instantly accessible.',
      'demo.d4.sub3.voice': 'Your entire SOP library, instantly accessible from the floor.',

      'demo.d5.title':      'Raise a Concern',
      'demo.d5.desc':       'The operator flags what they found. Plain language. 30 seconds. Done.',
      'demo.d5.voice':      'Now the operator clicks Raise a Concern. Describes what they found in plain language. 30 seconds. Done. Back to work.',
      'demo.d5.sub1.title': 'What You Found',
      'demo.d5.sub1.desc':  'PBR says 100L, SOP says 150L — describe the mismatch.',
      'demo.d5.sub1.voice': 'PBR says 100 litres, SOP says 150. Write it down or speak it.',
      'demo.d5.sub2.title': 'Priority',
      'demo.d5.sub2.desc':  'Flag the urgency. This one\'s high — fifty thousand euro filter at risk.',
      'demo.d5.sub2.voice': 'Flag the priority. This one\'s high — fifty thousand euro filter at risk.',
      'demo.d5.sub3.title': 'Evidence',
      'demo.d5.sub3.desc':  'Attach a photo of the batch record step.',
      'demo.d5.sub3.voice': 'Attach a photo of the PBR step. Visual evidence.',
      'demo.d5.sub4.title': 'Submit',
      'demo.d5.sub4.desc':  'Goes straight to QA Document Control. Anonymous.',
      'demo.d5.sub4.voice': 'Hit submit. Goes straight to QA Document Control. Anonymous.',

      'demo.d6.title':      'Next: QA Document Control',
      'demo.d6.desc':       'Let\'s see the other side — where that concern lands.',
      'demo.d6.voice':      'Now let\'s see the other side. Where does that concern go?',

      // ── DEMO TOUR — Part 2 (QA Control Centre) ───────────────────────────
      'qtour.step1.title':      'QA Document Control',
      'qtour.step1.desc':       'That concern just landed here. QA sees it immediately.',
      'qtour.step1.voice':      'This is QA Document Control. That concern we just raised? It landed right here.',

      'qtour.step2.title':      'Submissions',
      'qtour.step2.desc':       'Every concern from the floor, organised by priority.',
      'qtour.step2.voice':      'Every submission from the floor, organised by priority.',
      'qtour.step2.sub1.title': 'Priority Filters',
      'qtour.step2.sub1.desc':  'Filter by High, Medium, or Low. High concerns surface immediately.',
      'qtour.step2.sub1.voice': 'Filter by priority. High concerns surface immediately.',
      'qtour.step2.sub2.title': 'Submission Cards',
      'qtour.step2.sub2.desc':  'Reference code, priority, summary, and date.',
      'qtour.step2.sub2.voice': 'Each card shows the concern, priority, and when it was raised.',
      'qtour.step2.sub3.title': 'Status Tracking',
      'qtour.step2.sub3.desc':  'Colour-coded priority. Status badges track the workflow.',
      'qtour.step2.sub3.voice': 'Colour-coded by priority. Status badges track the workflow.',

      'qtour.step3.title':      'The Diff',
      'qtour.step3.desc':       'QA gets a clear diff — PBR says 100L, SOP says 150L — with supporting docs already pulled.',
      'qtour.step3.voice':      'QA opens the concern and gets a clear diff — the PBR says 100 litres, the SOP says 150 litres. Supporting documentation already pulled.',
      'qtour.step3.sub1.title': 'Workflow',
      'qtour.step3.sub1.desc':  'New, under review, corrective action, approved, closed.',
      'qtour.step3.sub1.voice': 'Full workflow tracking. New, under review, corrective action, approved, closed.',
      'qtour.step3.sub2.title': 'Observation',
      'qtour.step3.sub2.desc':  'The raw observation, exactly as the operator reported it.',
      'qtour.step3.sub2.voice': 'The raw observation, exactly as the operator reported it.',
      'qtour.step3.sub3.title': 'Document References',
      'qtour.step3.sub3.desc':  'Referenced SOPs pulled automatically by the AI.',
      'qtour.step3.sub3.voice': 'Referenced SOPs and batch records, pulled automatically.',

      'qtour.step4.title':      'Corrective Actions',
      'qtour.step4.desc':       'The AI proposes specific changes to the SOP, with justification.',
      'qtour.step4.voice':      'The AI proposes specific corrective actions — what should change in the SOP, and why.',

      'qtour.step5.title':      'SOP Viewer',
      'qtour.step5.desc':       'Review, approve, and push changes into the next PBR revision.',
      'qtour.step5.voice':      'QA can review the change, approve it, and push it into the next PBR revision.',
      'qtour.step5.sub1.title': 'Current vs Proposed',
      'qtour.step5.sub1.desc':  'Current SOP text alongside the suggested amendment.',
      'qtour.step5.sub1.voice': 'Current text alongside the proposed amendment. The issue highlighted.',
      'qtour.step5.sub2.title': 'Actions',
      'qtour.step5.sub2.desc':  'Accept, reject, or write a custom change. Every action logged.',
      'qtour.step5.sub2.voice': 'Accept, reject, or write a custom change. Every action recorded.',

      'qtour.step6.title':      'Audit Trail & E-Signature',
      'qtour.step6.desc':       'Full audit trail. E-signatures. 21 CFR Part 11 compliant.',
      'qtour.step6.voice':      'Full audit trail. E-signatures for QA approval and director sign-off. 21 CFR Part 11 compliant.',

      'qtour.step7.title':      'That\'s Vent',
      'qtour.step7.desc':       'What used to take weeks now takes minutes.',
      'qtour.step7.voice':      'What used to take weeks of verbal handoffs and Excel sheets now takes minutes. That\'s Vent.',
    },
    ...
    zh: {
      ...
      'fb.title':               '语音反馈',
      'fb.sessions':            '反馈会话',
      'fb.noSessions':          '暂无反馈会话。点击球体开始一个。',
      'fb.startSession':        '开始反馈会话',
      'fb.endSession':          '结束会话',
      'fb.tapToStart':          '点击球体开始反馈会话',
      'fb.recording':           '正在收听\u2026 分享您的想法',
      'fb.thinking':            '处理中\u2026',
      'fb.speaking':            'Charlie 正在回复\u2026',
      'fb.sessionEnded':        '会话完成 \u2014 正在分析反馈',
      'fb.analysing':           '正在分析反馈\u2026',
      'fb.analysed':            '分析完成',
      'fb.generatePrompt':      '生成提示',
      'fb.generatingPrompt':    '正在生成实施提示\u2026',
      'fb.promptReady':         '提示已就绪 \u2014 复制到剪贴板',
      'fb.copied':              '已复制！',
      'fb.copyPrompt':          '复制到剪贴板',
      'fb.trendReport':         '趋势报告',
      'fb.generateTrend':       '生成趋势报告',
      'fb.export':              '导出',
      'fb.transcript':          '对话记录',
      'fb.analysis':            '分析',
      'fb.categories':          '类别',
      ...
      'fb.filterAll':           '全部',
      'fb.filterActive':        '进行中',
      'fb.filterCompleted':     '已完成',
      'fb.filterAnalysed':      '已分析',
      'fb.batchAnalyse':        '批量分析',
      'fb.voiceCapture':        '语音捕获',
      'fb.noSelection':         '选择一个会话查看详情',
      'fb.reanalyse':           '重新分析',
      'fb.promptPanel':         '生成的提示',
      'fb.active':              '进行中',
      'fb.completed':           '已完成',
    ...
    es: {
      ...
      'nav.feedback':           'Comentarios',
      'fb.title':               'Comentarios por Voz',
      'fb.sessions':            'Sesiones de Comentarios',
      'fb.noSessions':          'A\u00fan no hay sesiones. Toca el orbe para iniciar una.',
      'fb.startSession':        'Iniciar Sesi\u00f3n de Comentarios',
      'fb.endSession':          'Finalizar Sesi\u00f3n',
      'fb.tapToStart':          'Toca el orbe para iniciar una sesi\u00f3n de comentarios',
      'fb.recording':           'Escuchando\u2026 comparte tus ideas',
      'fb.thinking':            'Procesando\u2026',
      'fb.speaking':            'Charlie est\u00e1 respondiendo\u2026',
      'fb.sessionEnded':        'Sesi\u00f3n completa \u2014 analizando comentarios',
      'fb.analysing':           'Analizando comentarios\u2026',
      'fb.analysed':            'An\u00e1lisis completo',
      'fb.generatePrompt':      'Generar Prompt',
      'fb.generatingPrompt':    'Generando prompt de implementaci\u00f3n\u2026',
      'fb.promptReady':         'Prompt listo \u2014 copiar al portapapeles',
      'fb.copied':              '\u00a1Copiado!',
      'fb.copyPrompt':          'Copiar al Portapapeles',
      'fb.trendReport':         'Informe de Tendencias',
      'fb.generateTrend':       'Generar Informe de Tendencias',
      'fb.export':              'Exportar',
      'fb.transcript':          'Transcripci\u00f3n',
      'fb.analysis':            'An\u00e1lisis',
      'fb.categories':          'Categor\u00edas',
      'fb.sentiment':           'Sentimiento',
      'fb.severity':            'Severidad',
      'fb.keyQuotes':           'Citas Clave',
      'fb.actionItems':         'Elementos de Acci\u00f3n',
      'fb.summary':             'Resumen',
      'fb.filterAll':           'Todo',
      'fb.filterActive':        'Activo',
      'fb.filterCompleted':     'Completado',
      'fb.filterAnalysed':      'Analizado',
      'fb.batchAnalyse':        'An\u00e1lisis por Lotes',
      'fb.voiceCapture':        'Captura de Voz',
      'fb.noSelection':         'Selecciona una sesi\u00f3n para ver detalles',
      'fb.reanalyse':           'Re-analizar',
      'fb.promptPanel':         'Prompt Generado',
      'fb.active':              'Activo',
      'fb.completed':           'Completado',
