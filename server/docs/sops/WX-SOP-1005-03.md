...
| Field | Detail |
|---|---|
| **Document Number** | WX-SOP-1005-03 |
...
This SOP does not cover CIP/SIP of the ATF hollow fibre system (refer to WX-SOP-1004-03) or media preparation vessels (refer to SOP-CL-002).
...
8.4.1.2 Reinstall all probes, ports, and lines required for the production run per WX-SOP-1001-03, Section 8.3. Confirm assembly against AD-UP-001.
...
*WX-SOP-1005-03 Rev 03 | Classification: GMP Controlled | UNCONTROLLED WHEN PRINTED*
