...
| Field | Detail |
|---|---|
| **Document Number** | WX-SOP-1004-03 |
...
8.1.1.1 Confirm that the ATF controller has a current calibration certificate and that the pressure transducers (P1 and P2) are calibrated and within due date. Record in WX-BPR-2001-03, Section 10.
...
8.4.3 Record ATF start time in BPR Section 10. ATF start time is typically coincident with or shortly after perfusion initiation (refer to WX-SOP-1002-03, Section 8.6).
...
8.8.1 Stop the perfusion pump (WX-SOP-1002-03). Stop the bleed pump (WX-SOP-1003-03).
...
*WX-SOP-1004-03 Rev 02 | Classification: GMP Controlled | UNCONTROLLED WHEN PRINTED*
